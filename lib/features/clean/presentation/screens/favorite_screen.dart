...
class _FavoriteScreenState extends ConsumerState<FavoriteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        ...
        middle: Text(
          _selectedIndex != null ? 'Favorite' : 'Favorite',
  ...
  Widget _buildEmptyState() {
    return const Center(
      child: Text('No favorite photos yet', style: TextStyle(color: CupertinoColors.systemGrey)),
    );
  }
            ...
            children: [
              ...
              _ActionButton(
                ...
                onPressed: () async {
                  ...
                  await repo.toggleFavorite(asset);
  ...
  Widget build(BuildContext context) {
    return CupertinoButton(
      ...
      child: Container(
        ...
        child: Icon(icon, color: const Color(0xFF48BB78), size: 24),
      ),
    );
  }
}
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFFFFEBEB), width: 8),
